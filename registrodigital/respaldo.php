...
try {
    ...
    foreach ($conn->query("SELECT * FROM  registros ;") as $row ){
            ...
            echo "<tr>  <td>".$row['id']."</td><td> ".$row['nombre']."</td><td>".$row['apellido']."</td><td> ".$row['email']."</td><td> ".$row['telefono']."</td><td> ".$row['ticke']."</td><td> " .$row['sucursal']."</td><td> " .$row['nacimiento']."</td> </tr>";
        }
